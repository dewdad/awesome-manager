...
export declare type WechatEvent =
  | "friend"
  | "login"
  | "logout"
  | "message"
 ...
 *
 */
export declare class Wechaty extends
  private options;
  /**
   * singleton _instance
   * @private
  ...
  on(
    event: "friend",
    listener: string | ((this: Wechaty, friend: Contact, request?: FriendRequest) => void),
  ): this;
  ...
  on(
    event: "room-leave",
    listener: string | ((this: Wechaty, room: Room, leaverList: Contact[]) => void),
  ): this;
  on(
    event: "room-topic",
    listener:
