...
export const MailItem = [
  {
    id: 'bb428c03-1bc6-4f3d-9d5e-268ec44eebc3',
    type: 'trashed',
    tag: 'Promotion',
  ...
  {
    id: 'a19bf9fc-e877-49e7-a75a-b089a2c35f18',
    type: 'draft',
    tag: 'Social',
  ...
  {
    id: '910d7e0a-f3b0-47a7-bb53-9036ed717298',
    type: 'starred',
    tag: 'Work',
  ...
  {
    id: 'c79cb60a-baf8-4349-b9c3-88d567b965a2',
    type: 'draft',
    tag: 'Social',
  ...
  {
    id: '35bddac1-1046-4c96-a1ac-ffd75def7f5a',
    type: 'trashed',
    tag: 'Social',
  ...
  {
    id: '0c914dfd-be0d-4d46-b963-47bcb064154f',
    type: 'sent',
    tag: 'Work',
  ...
  {
    id: '11538c3a-f2a7-4a7c-a237-4e61aa96423b',
    type: 'sent',
    tag: 'Personal',
  ...
  {
    id: '0f0a5482-8e4f-42a0-b3bb-1f96bc04d85a',
    type: 'draft',
    tag: 'Promotion',
  ...
  {
    id: '2b0e4083-00e4-48fd-9cb3-05434767ca66',
    type: 'starred',
    tag: 'Work',
  ...
  {
    id: 'bf7ab76b-c076-4992-a580-13b1859cd395',
    type: 'sent',
    tag: 'Work',
  ...
  {
    id: '2d72dac8-42e8-4414-b14f-6b1680cbdcfb',
    type: 'starred',
    tag: 'Personal',
  ...
  {
    id: '156dfed3-0235-4a38-a5b2-6a99a2a39d59',
    type: 'sent',
    tag: 'Personal',
  ...
  {
    id: '2eedaa3e-1509-49fc-b60b-069bfc83558b',
    type: 'trashed',
    tag: 'Personal',
  ...
  {
    id: 'ef82e384-801e-49fb-91d4-1472ddc124fb',
    type: 'trashed',
    tag: 'Promotion',
  ...
  {
    id: 'dae6e84d-4adb-4170-bc5f-087bc01b903d',
    type: 'draft',
    tag: 'Personal',
  ...
  {
    id: 'afe865e9-1c5b-49b4-8832-3186efc50304',
    type: 'sent',
    tag: 'Personal',
  ...
  {
    id: '38c6b789-dab8-41e3-8448-e498140f797e',
    type: 'draft',
    tag: 'Social',
  ...
  {
    id: '8bbcd627-394c-4a14-bc69-b357f7bc2547',
    type: 'draft',
    tag: 'Personal',
  ...
  {
    id: '60c2248b-3cb2-4fdf-b157-770f07d2a1f3',
    type: 'trashed',
    tag: 'Work',
  ...
  {
    id: '59608cba-b69e-4c05-b1f8-39d2e9c16fdc',
    type: 'sent',
    tag: 'Personal',
...
MailItem.map((item: any) => {
  ...
  item.from = users.find(x => x.id === item.fromId)
  return item
})

// mail submenu, main Menu in menu.js
...
export const getMail = limit => {
  return limit ? MailItem.slice(0, limit) : MailItem
}

export const getMailById = id => {
  return id === undefined ? MailItem[0] : MailItem.find(x => x.id === id)
}

export const getMailByType = type => {
  return type === 'all' ? MailItem : MailItem.filter(x => x.type === type)
}
export default { getMail, MailMenu, getMailById, getMailByType }
