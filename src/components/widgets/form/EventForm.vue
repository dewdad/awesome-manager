            ...
            <v-menu
              ...
              <v-date-picker
                ...
                <v-btn
                    flat
                    color="primary"
                    @click="$refs.statDate.save(startDate)">OK</v-btn>
              </v-date-picker>
            </v-menu>
          </v-flex>
          <v-flex
            ...
            <v-menu
              ...
              <v-time-picker v-model="startTime">
                ...
                <v-btn
                    flat
                    color="primary"
                    @click="$refs.startTime.save(startTime)">OK</v-btn>
              </v-time-picker>
            </v-menu>
          </v-flex>
          <v-flex
            ...
            <v-menu
              ...
              <v-date-picker
                ...
                <v-btn
                    flat
                    color="primary"
                    @click="endDateMenu = false">Cancel</v-btn>
                <v-btn
                    flat
                    color="primary"
                    @click="$refs.endDate.save(endDate)">OK</v-btn>
              </v-date-picker>
            </v-menu>
          </v-flex>
          <v-flex
            ...
            <v-menu
              ...
              <v-time-picker v-model="endTime" >
                ...
                <v-btn
                    flat
                    color="primary"
                    @click="$refs.endTime.save(endTime)">OK</v-btn>
              </v-time-picker>
            </v-menu>
          </v-flex>
          <v-flex
