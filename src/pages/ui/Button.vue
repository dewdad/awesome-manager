          ...
          <v-widget
            ...
            <div slot="widget-content">
              <div>
                <v-btn
                    color="success"
                    depressed="">Success</v-btn>
                <v-btn
                    color="error"
                    depressed>Error</v-btn>
                <v-btn
                    color="warning"
                    depressed>Warning</v-btn>
                <v-btn
                    color="info"
                    depressed>Info</v-btn>
              </div>
            </div>
          </v-widget>
          <v-widget
            ...
            <div slot="widget-content">
              <div>
                <v-btn
                    color="success"
                    outline="">Success</v-btn>
                <v-btn
                    color="error"
                    outline>Error</v-btn>
                <v-btn
                    color="warning"
                    outline>Warning</v-btn>
                <v-btn
                    color="info"
                    outline>Info</v-btn>
              </div>
                    ...
                    <div class="text-xs-center">
                      <div>
                        <v-btn
                            small
                            color="primary"
                            dark>Small Button</v-btn>
                      </div>
                      <div>
                        <v-btn
                            color="warning"
                            dark>Normal Button</v-btn>
                      </div>
                      <div>
                        <v-btn
                            color="error"
