        ...
        <v-flex sm12>
          ...
          <v-stepper v-model="step">
            <v-stepper-header>
              <v-stepper-step
                  step="1"
                  :complete="step > 1">Name of step 1</v-stepper-step>
              <v-divider></v-divider>
              <v-stepper-step
                  step="2"
                  :complete="step > 2">Name of step 2</v-stepper-step>
              <v-divider></v-divider>
            ...
            <v-stepper-items>
              <v-stepper-content step="1">
                ...
                <v-btn
                    color="primary"
                    @click.native="step = 2">Continue</v-btn>
              ...
              <v-stepper-content step="2">
                ...
                <v-btn
                    color="primary"
                    @click.native="step = 3">Continue</v-btn>
                <v-btn flat>Cancel</v-btn>
              </v-stepper-content>
              <v-stepper-content step="3">
                ...
                <v-btn
                    color="primary"
                    @click.native="step = 1">Continue</v-btn>
                <v-btn flat>Cancel</v-btn>
              </v-stepper-content>
            </v-stepper-items>
          </v-stepper>
        ...
        <v-flex sm12>
          ...
          <v-stepper
            ...
            <v-stepper-content step="4">
              ...
              <v-btn
                  color="primary"
                  @click.native="e13 = 1">Continue</v-btn>
              <v-btn flat>Cancel</v-btn>
            </v-stepper-content>
          </v-stepper>
        </v-flex>
